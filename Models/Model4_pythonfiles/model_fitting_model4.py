...
print('bifurmean', parameters[25])
print("sigmaL", parameters[13])
print('sigmaR', parameters[14])
...
print('Jmu', parameters[21])
print('Jlam', parameters[22])
print('Jgam', parameters[23])
print('Jdel',parameters[24])

Johnson = RooJohnson("Johnson","Johnson", D0_M, Jmu, Jlam, Jgam, Jdel)

# Model Exponential Background
a = RooRealVar("a0", "a0", parameters[0])
print('a0', parameters[0])

background = RooExponential("Exponential", "Exponential", D0_M, a)

# Model Gaussian
mean = RooRealVar("mean", "mean", parameters[30])
sigma = RooRealVar("sigma", "sigma", parameters[31])
gauss = RooGaussian("Gaussian", "Gaussian", D0_M, mean, sigma)
print('mean', parameters[30])
print('sigma', parameters[31])


# Model Gaussian 2
mean2 = RooRealVar("mean2", "mean2", parameters[15])
sigma2 = RooRealVar("sigma2", "sigma2", parameters[16])
print('mean2', parameters[15])
print('sigma2', parameters[16])
...
if options.meson == "D0":
    ...
    if options.polarity == "down":
        ...
        frac3 = RooRealVar("frac_D0_down_3", "frac_D0_down_3", parameters[32])
        print('frac', parameters[1])
        print('frac2', parameters[17])
        print('frac3', parameters[32])
        

        Nsig = RooRealVar("Nbkg_D0_up", "Nbkg_D0_up", parameters[5])
        Nbkg = RooRealVar("Nbkg_D0_down", "Nbkg_D0_down", parameters[6])
        #Nbkg = RooRealVar("Nbkg_D0_down", "Nbkg_D0_down", 1658178)

        Nsig_error = parameters[26]
        print('Nsig', parameters[5])
        print('Nbkg', parameters[6])
    ...
    # D0 MagUp
        ...
        frac3 = RooRealVar("frac_D0_up_3", "frac_D0_up_3", parameters[33])
        print('frac', parameters[2])
        print('frac', parameters[18])
        print('frac', parameters[33])
    ...
    if options.polarity == "down":
        ...
        frac3 = RooRealVar("frac_D0bar_down_3", "frac_D0down_down_3", parameters[34])
    ...
    # D0bar MagUp
        ...
        frac3 = RooRealVar("frac_D0bar_up_3", "frac_D0bar_up_3", parameters[35])
