"""
fit_global_model4.py

Gauss Gauss Bifurcated Johnson
...
Jmu = RooRealVar("Jmu", "Jmu", 1.8674e+03 , 1860, 1870)
Jlam = RooRealVar("Jlam", "Jlam", 1.7928e+01 , 10, 20)
Jgam = RooRealVar("Jgam", "Jgam", 2.4088e-01, 0, 10)
Jdel = RooRealVar("Jdel", "Jdel", 1.6387e+00, 0, 10)
Johnson = RooJohnson("Johnson","Johnson", D0_M, Jmu, Jlam, Jgam, Jdel)

# Bifurcated Gaussian
bifurmean = RooRealVar("bifurmean", "bifurmean", 1.8658e+03, 1860, 1870)
sigmaL =  RooRealVar("sigmaL", "sigmaL", 6.7608e+00 , 0, 10)
sigmaR = RooRealVar("sigmaR", "sigmaR", 6.6951e+00, 0, 10)
bifurgauss = RooBifurGauss("Bifurgauss1", "Bifurgauss1", D0_M, bifurmean, sigmaL, sigmaR)

# Gaussian
mean = RooRealVar("mean", "mean", 1.8651e+03, 1860, 1870)
sigma = RooRealVar("sigma", "sigma", 7.51, 0, 20)
gauss = RooGaussian("Gaussian", "Gaussian", D0_M, mean, sigma)

# Gaussian
mean2 = RooRealVar("mean2", "mean2", 1865, 1860, 1870)
sigma2 = RooRealVar("sigma2", "sigma2", 7.54, 0, 20)
gauss2 = RooGaussian("Gaussian2", "Gaussian2", D0_M, mean2, sigma2)

# Model Exponential Background
a0 = RooRealVar("a0", "a0", -9.0819e-03, -1.0019e-02, -8.0819e-03)
...
# DO MagUp 
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.9, 0, 1)
frac_D0_up_2 = RooRealVar("frac_D0_up_2", "frac_D0_up_2", 0.28, 0, 1)
frac_D0_up_3 = RooRealVar("frac_D0_up_3", "frac_D0_up_3", 0.35, 0, 1)

# D0 MagDown
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 1.9521e-01 , 0, 1)
frac_D0_down_2 = RooRealVar("frac_D0_down_2", "frac_D0_down_2", 2.0498e-01 , 0, 1)
frac_D0_down_3 = RooRealVar("frac_D0_down_3", "frac_D0_down_3", 5.1896e-01 , 0, 1)
# D0bar MagUp2
...
Nbkg_D0_up = ROOT.RooRealVar("Nbkg_D0_up", "Nbkg_D0_up", 0.03*ttree_D0_up.GetEntries(), 0, ttree_D0_up.GetEntries())
Nbkg_D0bar_up = ROOT.RooRealVar("Nbkg_D0bar_up", "Nbkg_D0bar_up", 0.03*ttree_D0bar_up.GetEntries(), 0, ttree_D0bar_up.GetEntries())
...
Nbkg_D0_down = ROOT.RooRealVar("Nbkg_D0_down", "Nbkg_D0_down", 0.03*ttree_D0bar_down.GetEntries(), 0, ttree_D0_down.GetEntries())
Nbkg_D0bar_down = ROOT.RooRealVar("Nbkg_D0bar_down", "Nbkg_D0bar_down", 0.03*ttree_D0bar_down.GetEntries(), 0, ttree_D0bar_down.GetEntries())
